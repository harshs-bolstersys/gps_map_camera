...
class LocationsState {
  ...
  LocationsState copyWith({List<SavedLocation>? locations, bool? isAdding}) =>
      LocationsState(locations: locations ?? this.locations, isAdding: isAdding ?? this.isAdding);
}
...
final locationsControllerProvider = StateNotifierProvider<LocationsController, LocationsState>((ref) => LocationsController());
